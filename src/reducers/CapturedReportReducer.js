...
export default function(state=[],action){
  ...
  switch(action.type){
    ...
    case DELETE_MAINTAIN_RULE_DATA:
      console.log('In capturereport reducer for delete cell calc rules',state.drill_down_result.cell_rules.length,state.drill_down_result.cell_rules,action.meta)
